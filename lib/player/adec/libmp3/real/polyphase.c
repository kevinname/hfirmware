...
void PolyphaseMono(short *pcm, int *vbuf, const int *coefBase) {
  ...
  *(pcm + 16) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  ...
  for (i = 15; i > 0; i--) {
    ...
    *(pcm + 2 * i) = ClipToShort(
        (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
    pcm++;
  }
}
...
static int *vb1;
static int vLo, vHi, c1, c2;
static __int64 sum1L, sum2L, sum1R, sum2R, rndVal;

static inline short * PolyphaseStereo_1(short *pcm, int *vbuf, const int *coefBase) __attribute__ ((section (".mp3text"), optimize(s), always_inline));
static inline short * PolyphaseStereo_1(short *pcm, int *vbuf, const int *coefBase){
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 15 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 15 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 14 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 14 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
...
static inline short * PolyphaseStereo_2(short *pcm, int *vbuf, const int *coefBase) __attribute__ ((section (".mp3text"), optimize(s), always_inline));
static inline short * PolyphaseStereo_2(short *pcm, int *vbuf, const int *coefBase){
  (void)vbuf;
  (void)coefBase;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 13 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 13 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 12 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 12 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 11 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 11 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 10 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 10 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
...
//static short * PolyphaseStereo_3(short *pcm, int *vbuf, const int *coefBase) __attribute__ ((noinline));
static inline short * PolyphaseStereo_3(short *pcm, int *vbuf, const int *coefBase) __attribute__ ((section (".mp3text"), optimize(s), always_inline));
static inline short * PolyphaseStereo_3(short *pcm, int *vbuf, const int *coefBase)
{
  (void)vbuf;
  (void)coefBase;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 9 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 9 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 8 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 8 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 7 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 7 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 6 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 6 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 5 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 5 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
...
static inline short * PolyphaseStereo_4(short *pcm, int *vbuf, const int *coefBase)  __attribute__ ((section (".mp3text"), optimize(s), always_inline));
static inline short * PolyphaseStereo_4(short *pcm, int *vbuf, const int *coefBase){
  (void)vbuf;
  (void)coefBase;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 4 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 4 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 3 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 3 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 2 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 2 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
  ...
  *(pcm + 0) = ClipToShort((int) SAR64(sum1L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 1) = ClipToShort((int) SAR64(sum1R, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 1 + 0) = ClipToShort(
      (int) SAR64(sum2L, (32 - CSHIFT)), DEF_NFRACBITS);
  *(pcm + 2 * 2 * 1 + 1) = ClipToShort(
      (int) SAR64(sum2R, (32 - CSHIFT)), DEF_NFRACBITS);
  pcm += 2;
...
void PolyphaseStereo(short *pcm, int *vbuf, const int *coefBase) __attribute__ ((section (".mp3text"), optimize(s)));
void PolyphaseStereo(short *pcm, int *vbuf, const int *coefBase){
  short *pcm_t;
    
  pcm_t = PolyphaseStereo_1(pcm,   vbuf, coefBase);
  pcm_t = PolyphaseStereo_2(pcm_t, vbuf, coefBase);
  pcm_t = PolyphaseStereo_3(pcm_t, vbuf, coefBase);
  pcm_t = PolyphaseStereo_4(pcm_t, vbuf, coefBase);
}
