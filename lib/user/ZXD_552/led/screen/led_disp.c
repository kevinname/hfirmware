...
#define LED_PIN5    PA15
#define LED_PIN6    PB2
#define LED_PIN7    PA13
...
volatile uint8_t g_u8Dig_r[] = {LED_DIG_E, LED_DIG_G};
volatile uint8_t g_u8Dig_c[] = {LED_DIG_A, LED_DIG_D, LED_DIG_E, LED_DIG_F};
...
volatile hs_led_diginfo_t g_stDig[] = 
{
  ...
  {g_u8Dig_r, sizeof(g_u8Dig_r)},         /* 19 r */
  {g_u8Dig_c, sizeof(g_u8Dig_c)},         /* 20 c */
