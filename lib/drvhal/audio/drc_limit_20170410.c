...
void main()
{
	...
	//8KHz
	unsigned short rt =0x0012;
	unsigned short at =0xe3a2;
	unsigned short rt1=0x0036;
	unsigned short at1=0xffa6;
	short LT=115; //(115-127)/2=-12dB
	short NT=27;  //(47-127)/2=-40dB
	...
	if ( ( ( pfIn = fopen( "FESignal8k_scale.wav", "rb" ) ) == NULL ))
	{
