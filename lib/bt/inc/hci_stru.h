...
#ifdef CONFIG_BLE
/* 05,[0x06] LE Meta Event */
struct HCI_LE_Remote_Connection_Param_RequestEvStru {
...
/* 06,[0x07] LE Meta Event */
struct HCI_LE_Data_Length_ChangeEvStru {
	UINT16 connection_handle;
...
/* 07,[0x08] LE Meta Event */
struct HCI_LE_Read_Local_Public_Key_CompleteEvStru {
    UINT8 status;
    UINT8 local_P256_public_key[64];
};

/* 08,[0x09] LE Meta Event */
struct HCI_LE_Generate_DHKey_CompleteEvStru {
    UINT8 status;
    UINT8 DHkey[32];
};

/* 09,[0x0a] LE Meta Event */
struct HCI_LE_Enhanced_Connection_CompleteEvStru {
    UINT8 status;
    UINT16 connection_handle;
    UINT8 role;
    UINT8 peer_address_type;
    UINT8 peer_address[6];
    UINT8 local_resolvable_private_address[6];
    UINT8 peer_resolvable_private_address[6];
...
/* 0a,[0x0b] LE Meta Event */
struct HCI_LE_Direct_Advertising_ReportEvStru {
	UINT8 num_reports;                     /* [294],Val */
	UINT8 param_plen;                      /* Data Need to Phase by context param */
	UINT8 param[1];                        /* [283],Val */
};
...
static const UINT8 hci_table_coding_Event[] = {/* [Event] [Len:105] */

	0x65,0x55,0x29,0x59,0xc3,0x03,
	0x61,0x55,0x95,0x92,0x00,
	0x95,0x55,0xdd,0xdd,0x00,
	0x95,0x55,0xd5,0xdd,0x0d,
	0x61,0x55,0x29,
	0x59,0x00,
	0x95,0x56,0x55,0x65,
	0x16,
	0x95,0x55,0x56,0x66,0x16,
	0x95,0x55,
	0x99,0x00,
	0x95,0x99,0x99,0x00,
	0x95,0x56,0x15,
...
static const UINT8 hci_table_coding_Command[] = {/* [Command] [Len:145] */

	0x99,0x55,0x56,0x65,0x66,0x66,0x02,
	0x59,0x55,0xdd,0xdd,0x00,
	0x99,0x55,0x65,0x55,0x01,
	0x56,0x56,
	0x65,0x01,
	0xd9,0x9d,0x59,
	0x09,
...
static const UINT8 hci_table_codingoff_Event[] = {/* [Event] [Len:59] */

	0x4e,0x06,0x2c,0x2f,0x4d,0x4f,0x32,0x4d,0x4f,0x4d,0x51,0x35,0x0b,0x53,0x55,0x4e,
	0x37,0x57,0x59,0x38,0x3b,0x1e,0x1e,0x3e,0x54,0x4e,0x18,0x5b,0x5b,0x37,0x5d,0x5d,
	0x10,0x15,0x41,0x1a,0x24,0x28,0x00,0x4f,0x1e,0x44,0x5f,0x1e,0x1e,0x61,0x26,0x37,
	0x5f,0x5d,0x63,0x65,0x47,0x54,0x1f,0x65,0x4a,0x51,0x67
};
...
enum {
	HCI_EVI_INQUIRY_COMPLETE =                                 0x00,                    /* 00,[EvCode:0x01],[1.1,BREDR,[DEVICE DISCOVERY]] */
	/* [status[1]] */

	HCI_EVI_INQUIRY_RESULT =                                   0x01,                    /* 01,[EvCode:0x02],[1.1,BREDR,[DEVICE DISCOVERY]] */
	/* [num_responses[n],bd[6],page_scan_repetition_mode[1],page_scan_period_mode[1],page_scan_mode[1],class_of_device[3],clock_offset[2]] */

	HCI_EVI_CONNECTION_COMPLETE =                              0x02,                    /* 02,[EvCode:0x03],[1.1,BREDR,[CONNECTION SETUP]] */
	/* [status[1],connection_handle[2],bd[6],link_type[1],encryption_enable[1]] */

	HCI_EVI_CONNECTION_REQUEST =                               0x03,                    /* 03,[EvCode:0x04],[1.1,BREDR,[CONNECTION SETUP]] */
	/* [bd[6],class_of_device[3],link_type[1]] */

	HCI_EVI_DISCONNECTION_COMPLETE =                           0x04,                    /* 04,[EvCode:0x05],[1.1,BREDR/LE,[CONNECTION SETUP]] */
	/* [status[1],connection_handle[2],reason[1]] */

	HCI_EVI_AUTHENTICATION_COMPLETE =                          0x05,                    /* 05,[EvCode:0x06],[1.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [status[1],connection_handle[2]] */

	HCI_EVI_REMOTE_NAME_REQUEST_COMPLETE =                     0x06,                    /* 06,[EvCode:0x07],[1.1,BREDR,[REMOTE INFORMATION]] */
	/* [status[1],bd[6],remote_name[248]] */

	HCI_EVI_ENCRYPTION_CHANGE =                                0x07,                    /* 07,[EvCode:0x08],[1.1,BREDR/LE,[AUTHENTICATION AND ENCRYPTION]] */
	/* [status[1],connection_handle[2],encryption_enable[1]] */

	HCI_EVI_CHANGE_CONNECTION_LINK_KEY_COMPLETE =              0x08,                    /* 08,[EvCode:0x09],[1.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [status[1],connection_handle[2]] */

	HCI_EVI_MASTER_LINK_KEY_COMPLETE =                         0x09,                    /* 09,[EvCode:0x0a],[1.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [status[1],connection_handle[2],key_flag[1]] */

	HCI_EVI_READ_REMOTE_SUPPORTED_FEATURES_COMPLETE =          0x0a,                    /* 10,[EvCode:0x0b],[1.1,BREDR,[REMOTE INFORMATION]] */
	/* [status[1],connection_handle[2],lmp_features[8]] */

	HCI_EVI_READ_REMOTE_VERSION_INFORMATION_COMPLETE =         0x0b,                    /* 11,[EvCode:0x0c],[1.1,BREDR/LE,[REMOTE INFORMATION]] */
	/* [status[1],connection_handle[2],lmp_version[1],manufacturer_name[2],lmp_subversion[2]] */

	HCI_EVI_QOS_SETUP_COMPLETE =                               0x0c,                    /* 12,[EvCode:0x0d],[1.1,BREDR,[QUALITY OF SERVICE]] */
	/* [status[1],connection_handle[2],flags[1],service_type[1],token_rate[4],peak_bandwidth[4],latency[4],delay_variation[4]] */

	HCI_EVI_COMMAND_COMPLETE =                                 0x0d,                    /* 13,[EvCode:0x0e],[1.1,All,[GENERIC EVENTS]] */
	/* [num_hci_command_packets[1],command_opcode[2],return_parameters[x]] */

	HCI_EVI_COMMAND_STATUS =                                   0x0e,                    /* 14,[EvCode:0x0f],[1.1,All,[GENERIC EVENTS]] */
	/* [status[1],num_hci_command_packets[1],command_opcode[2]] */

	HCI_EVI_HARDWARE_ERROR =                                   0x0f,                    /* 15,[EvCode:0x10],[1.1,All,[GENERIC EVENTS]] */
	/* [hardware_code[1]] */

	HCI_EVI_FLUSH_OCCURRED =                                   0x10,                    /* 16,[EvCode:0x11],[1.1,BREDR/AMP,[QUALITY OF SERVICE]] */
	/* [handle[2]] */

	HCI_EVI_ROLE_CHANGE =                                      0x11,                    /* 17,[EvCode:0x12],[1.1,BREDR,[PICONET STRUCTURE]] */
	/* [status[1],bd[6],role[1]] */

	HCI_EVI_NUMBER_OF_COMPLETED_PACKETS =                      0x12,                    /* 18,[EvCode:0x13],[1.1,All,[CONTROLLER FLOW CONTROL]] */
	/* [number_of_handles[n],connection_handle[2],hc_num_of_completed_packets[2]] */

	HCI_EVI_MODE_CHANGE =                                      0x13,                    /* 19,[EvCode:0x14],[1.1,BREDR,[CONNECTION STATE]] */
	/* [status[1],connection_handle[2],current_mode[1],interval[2]] */

	HCI_EVI_RETURN_LINK_KEYS =                                 0x14,                    /* 20,[EvCode:0x15],[1.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [num_keys[n],bd[6],link_key[16]] */

	HCI_EVI_PIN_CODE_REQUEST =                                 0x15,                    /* 21,[EvCode:0x16],[1.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [bd[6]] */

	HCI_EVI_LINK_KEY_REQUEST =                                 0x16,                    /* 22,[EvCode:0x17],[1.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [bd[6]] */

	HCI_EVI_LINK_KEY_NOTIFICATION =                            0x17,                    /* 23,[EvCode:0x18],[1.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [bd[6],link_key[16],key_type[1]] */

	HCI_EVI_LOOPBACK_COMMAND =                                 0x18,                    /* 24,[EvCode:0x19],[1.1,BREDR,[TESTING]] */
	/* [hci_command_packet[x]] */

	HCI_EVI_DATA_BUFFER_OVERFLOW =                             0x19,                    /* 25,[EvCode:0x1a],[1.1,All,[HOST FLOW CONTROL]] */
	/* [link_type[1]] */

	HCI_EVI_MAX_SLOTS_CHANGE =                                 0x1a,                    /* 26,[EvCode:0x1b],[1.1,BREDR,[CONNECTION STATE]] */
	/* [connection_handle[2],lmp_max_slots[1]] */

	HCI_EVI_READ_CLOCK_OFFSET_COMPLETE =                       0x1b,                    /* 27,[EvCode:0x1c],[1.1,BREDR,[LINK INFORMATION]] */
	/* [status[1],connection_handle[2],clock_offset[2]] */

	HCI_EVI_CONNECTION_PACKET_TYPE_CHANGED =                   0x1c,                    /* 28,[EvCode:0x1d],[1.1,BREDR,[PHYSICAL LINKS]] */
	/* [status[1],connection_handle[2],packet_type[2]] */

	HCI_EVI_QOS_VIOLATION =                                    0x1d,                    /* 29,[EvCode:0x1e],[1.1,BREDR,[QUALITY OF SERVICE]] */
	/* [handle[2]] */

	HCI_EVI_PAGE_SCAN_MODE_CHANGE =                            0x1e,                    /* 30,[EvCode:0x1f],[1.1,BREDR,[CONNECTION SETUP]] */
	/* [bd[6],page_scan_mode[1]] */

	HCI_EVI_PAGE_SCAN_REPETITION_MODE_CHANGE =                 0x1f,                    /* 31,[EvCode:0x20],[1.1,BREDR,[CONNECTION SETUP]] */
	/* [bd[6],page_scan_repetition_mode[1]] */

	HCI_EVI_FLOW_SPECIFICATION_COMPLETE =                      0x20,                    /* 32,[EvCode:0x21],[1.2,BREDR,[QUALITY OF SERVICE]] */
	/* [status[1],connection_handle[2],flags[1],flow_direction[1],service_type[1],token_rate[4],token_bucket_size[4],peak_bandwidth[4],latency[4]] */

	HCI_EVI_INQUIRY_RESULT_WITH_RSSI =                         0x21,                    /* 33,[EvCode:0x22],[1.2,BREDR,[DEVICE DISCOVERY]] */
	/* [num_responses[n],bd[6],page_scan_repetition_mode[1],page_scan_period_mode[1],class_of_device[3],clock_offset[2],rssi[1]] */

	HCI_EVI_READ_REMOTE_EXTENDED_FEATURES_COMPLETE =           0x22,                    /* 34,[EvCode:0x23],[1.2,BREDR,[REMOTE INFORMATION]] */
	/* [status[1],connection_handle[2],page_number[1],max_page_number[1],extended_lmp_features[8]] */

	HCI_EVI_SYNCHRONOUS_CONNECTION_COMPLETE =                  0x23,                    /* 35,[EvCode:0x2c],[1.2,BREDR,[SYNCHRONOUS CONNECTIONS]] */
	/* [status[1],connection_handle[2],bd[6],link_type[1],transmission_interval[1],retransmission_window[1],rx_packet_length[2],tx_packet_length[2],air_mode[1]] */

	HCI_EVI_SYNCHRONOUS_CONNECTION_CHANGED =                   0x24,                    /* 36,[EvCode:0x2d],[1.2,BREDR,[SYNCHRONOUS CONNECTIONS]] */
	/* [status[1],connection_handle[2],transmission_interval[1],retransmission_window[1],rx_packet_length[2],tx_packet_length[2]] */

	HCI_EVI_SNIFF_SUBRATING =                                  0x25,                    /* 37,[EvCode:0x2e],[2.1,BREDR,[CONNECTION STATE]] */
	/* [status[1],connection_handle[2],max_transmit_latency[2],max_receive_latency[2],min_remote_timeout[2],min_local_timeout[2]] */

	HCI_EVI_EXTENDED_INQUIRY_RESULT =                          0x26,                    /* 38,[EvCode:0x2f],[2.1,BREDR,[DEVICE DISCOVERY]] */
	/* [num_responses[1],bd[6],page_scan_repetition_mode[1],reserved[1],class_of_device[3],clock_offset[2],rssi[1],extended_inquiry_response[240]] */

	HCI_EVI_ENCRYPTION_KEY_REFRESH_COMPLETE =                  0x27,                    /* 39,[EvCode:0x30],[2.1,BREDR/LE,[AUTHENTICATION AND ENCRYPTION]] */
	/* [status[1],connection_handle[2]] */

	HCI_EVI_IO_CAPABILITY_REQUEST =                            0x28,                    /* 40,[EvCode:0x31],[2.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [bd[6]] */

	HCI_EVI_IO_CAPABILITY_RESPONSE =                           0x29,                    /* 41,[EvCode:0x32],[2.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [bd[6],io_capability[1],oob_data_present[1],authentication_requirements[1]] */

	HCI_EVI_USER_CONFIRMATION_REQUEST =                        0x2a,                    /* 42,[EvCode:0x33],[2.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [bd[6],numeric_value[4]] */

	HCI_EVI_USER_PASSKEY_REQUEST =                             0x2b,                    /* 43,[EvCode:0x34],[2.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [bd[6]] */

	HCI_EVI_REMOTE_OOB_DATA_REQUEST =                          0x2c,                    /* 44,[EvCode:0x35],[2.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [bd[6]] */

	HCI_EVI_SIMPLE_PAIRING_COMPLETE =                          0x2d,                    /* 45,[EvCode:0x36],[2.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [status[1],bd[6]] */

	HCI_EVI_LINK_SUPERVISION_TIMEOUT_CHANGED =                 0x2e,                    /* 46,[EvCode:0x38],[2.1,BREDR,[PHYSICAL LINKS]] */
	/* [connection_handle[2],link_supervision_timeout[2]] */

	HCI_EVI_ENHANCED_FLUSH_COMPLETE =                          0x2f,                    /* 47,[EvCode:0x39],[2.1,BREDR/AMP,[QUALITY OF SERVICE]] */
	/* [handle[2]] */

	HCI_EVI_USER_PASSKEY_NOTIFICATION =                        0x30,                    /* 48,[EvCode:0x3b],[2.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [bd[6],passkey[4]] */

	HCI_EVI_KEYPRESS_NOTIFICATION =                            0x31,                    /* 49,[EvCode:0x3c],[2.1,BREDR,[AUTHENTICATION AND ENCRYPTION]] */
	/* [bd[6],notification_type[1]] */

	HCI_EVI_REMOTE_HOST_SUPPORTED_FEATURES_NOTIFICATION =      0x32,                    /* 50,[EvCode:0x3d],[2.1,BREDR,[REMOTE INFORMATION]] */
	/* [bd[6],host_supported_features[8]] */

	HCI_EVI_LE_META =                                          0x33,                    /* 51,[EvCode:0x3e],[4.0,LE,[LE]] */
	/* [sub_eventcode[1],param[x]] */

	HCI_EVI_NUMBER_OF_COMPLETED_DATA_BLOCKS =                  0x34,                    /* 52,[EvCode:0x48],[3.0,BREDR/AMP,[CONTROLLER FLOW CONTROL]] */
	/* [total_num_data_blocks[2],number_of_handles[n],handle[2],num_of_completed_packets[2],num_of_completed_blocks[2]] */

	HCI_EVI_VENDOR =                                           0x35,                    /* 53,[EvCode:0xff],[1.1,All,[VENDOR]] */
	/* [vendordata[x]] */

	HCI_EVI_LE_CONNECTION_COMPLETE =                           HCI_EVI_VENDOR + 0x01,   /* 54,[EvCode:0x01],[4.0,LE,[CONNECTION SETUP]] */
	/* [status[1],connection_handle[2],role[1],peer_address_type[1],peer_address[6],conn_interval[2],leconn_latency[2],supervision_timeout[2],master_clock_accuracy[1]] */

	HCI_EVI_LE_ADVERTISING_REPORT =                            HCI_EVI_VENDOR + 0x02,   /* 55,[EvCode:0x02],[4.0,LE,[DEVICE DISCOVERY]] */
	/* [num_reports[1],param[x]] */

	HCI_EVI_LE_CONNECTION_UPDATE_COMPLETE =                    HCI_EVI_VENDOR + 0x03,   /* 56,[EvCode:0x03],[4.0,LE,[CONNECTION STATE]] */
	/* [status[1],connection_handle[2],conn_interval[2],leconn_latency[2],supervision_timeout[2]] */

	HCI_EVI_LE_READ_REMOTE_USED_FEATURES_COMPLETE =            HCI_EVI_VENDOR + 0x04,   /* 57,[EvCode:0x04],[4.0,LE,[REMOTE INFORMATION]] */
	/* [status[1],connection_handle[2],le_features[8]] */

	HCI_EVI_LE_LONG_TERM_KEY_REQUEST =                         HCI_EVI_VENDOR + 0x05,   /* 58,[EvCode:0x05],[4.0,LE,[AUTHENTICATION AND ENCRYPTION]] */
...
static const struct HCI_IndexGapStru hci_table_evgap[] = {
	{/* Ev */0x2c,               /* Gap */8},                  /* 01,035,(0x2b) Synchronous_Connection_Complete */
	{/* Ev */0x38,               /* Gap */1},                  /* 02,046,(0x2f) Link_Supervision_Timeout_Changed */
	{/* Ev */0x3b,               /* Gap */1},                  /* 03,048,(0x31) User_Passkey_Notification */
	{/* Ev */0x48,               /* Gap */9},                  /* 04,052,(0x3d) Number_Of_Completed_Data_Blocks */
	{/* Ev */0xff,               /* Gap */182},                /* 05,053,(0xeb) Vendor */
};
...
static const struct HCI_EventCommandStru hci_table_evop[] = {
	{HCI_OPC_ACCEPT_SYNCHRONOUS_CONNECTION_REQUEST,            HCI_EVI_CONNECTION_COMPLETE}, /* 0 */
	{HCI_OPC_REJECT_SYNCHRONOUS_CONNECTION_REQUEST,            HCI_EVI_CONNECTION_COMPLETE}, /* 1 */
	{HCI_OPC_LE_START_ENCRYPTION,                              HCI_EVI_ENCRYPTION_CHANGE},   /* 2 */
};
...
/*---------------------------------------------------------------------------------*/
/* clock accuracy better than ¡À 20 ppm when not sleep, otherwise, ¡À 250 ppm */
...
/* This is the return parameter(s) for the command specified in the Command_Opcode
   event parameter. See each command¡¯s definition for the list of return
...
static const UINT16 hci_table_supportcmd[] = {

	/* Supported Commands[0] */
	0x0401,        /* INQUIRY */                                                   /* [1][0,0x01] */
	0x0402,        /* INQUIRY_CANCEL */                                            /* [2][0,0x02] */
	0x0403,        /* PERIODIC_INQUIRY_MODE */                                     /* [3][0,0x04] */
	0x0404,        /* EXIT_PERIODIC_INQUIRY_MODE */                                /* [4][0,0x08] */
	0x0405,        /* CREATE_CONNECTION */                                         /* [5][0,0x10] */
	0x0406,        /* DISCONNECT */                                                /* [6][0,0x20] */
	0x0407,        /* ADD_SCO_CONNECTION */                                        /* [7][0,0x40] */
	0x0408,        /* CREATE_CONNECTION_CANCEL */                                  /* [8][0,0x80] */

	/* Supported Commands[1] */
	0x0409,        /* ACCEPT_CONNECTION_REQUEST */                                 /* [9][1,0x01] */
	0x040a,        /* REJECT_CONNECTION_REQUEST */                                 /* [10][1,0x02] */
	0x040b,        /* LINK_KEY_REQUEST_REPLY */                                    /* [11][1,0x04] */
	0x040c,        /* LINK_KEY_REQUEST_NEGATIVE_REPLY */                           /* [12][1,0x08] */
	0x040d,        /* PIN_CODE_REQUEST_REPLY */                                    /* [13][1,0x10] */
	0x040e,        /* PIN_CODE_REQUEST_NEGATIVE_REPLY */                           /* [14][1,0x20] */
	0x040f,        /* CHANGE_CONNECTION_PACKET_TYPE */                             /* [15][1,0x40] */
	0x0411,        /* AUTHENTICATION_REQUESTED */                                  /* [16][1,0x80] */

	/* Supported Commands[2] */
	0x0413,        /* SET_CONNECTION_ENCRYPTION */                                 /* [17][2,0x01] */
	0x0415,        /* CHANGE_CONNECTION_LINK_KEY */                                /* [18][2,0x02] */
	0x0417,        /* MASTER_LINK_KEY */                                           /* [19][2,0x04] */
	0x0419,        /* REMOTE_NAME_REQUEST */                                       /* [20][2,0x08] */
	0x041a,        /* REMOTE_NAME_REQUEST_CANCEL */                                /* [21][2,0x10] */
	0x041b,        /* READ_REMOTE_SUPPORTED_FEATURES */                            /* [22][2,0x20] */
	0x041c,        /* READ_REMOTE_EXTENDED_FEATURES */                             /* [23][2,0x40] */
	0x041d,        /* READ_REMOTE_VERSION_INFORMATION */                           /* [24][2,0x80] */

	/* Supported Commands[3] */
	0x041f,        /* READ_CLOCK_OFFSET */                                         /* [25][3,0x01] */
	0x0420,        /* READ_LMP_HANDLE */                                           /* [26][3,0x02] */
	0x0000,        /* RESERVED */                                                  /* [27][3,0x04] */
	0x0000,        /* RESERVED */                                                  /* [28][3,0x08] */
	0x0000,        /* RESERVED */                                                  /* [29][3,0x10] */
	0x0000,        /* RESERVED */                                                  /* [30][3,0x20] */
	0x0000,        /* RESERVED */                                                  /* [31][3,0x40] */
	0x0000,        /* RESERVED */                                                  /* [32][3,0x80] */

	/* Supported Commands[4] */
	0x0000,        /* RESERVED */                                                  /* [33][4,0x01] */
	0x0801,        /* HOLD_MODE */                                                 /* [34][4,0x02] */
	0x0803,        /* SNIFF_MODE */                                                /* [35][4,0x04] */
	0x0804,        /* EXIT_SNIFF_MODE */                                           /* [36][4,0x08] */
	0x0805,        /* PARK_STATE */                                                /* [37][4,0x10] */
	0x0806,        /* EXIT_PARK_STATE */                                           /* [38][4,0x20] */
	0x0807,        /* QOS_SETUP */                                                 /* [39][4,0x40] */
	0x0809,        /* ROLE_DISCOVERY */                                            /* [40][4,0x80] */

	/* Supported Commands[5] */
	0x080b,        /* SWITCH_ROLE */                                               /* [41][5,0x01] */
	0x080c,        /* READ_LINK_POLICY_SETTINGS */                                 /* [42][5,0x02] */
	0x080d,        /* WRITE_LINK_POLICY_SETTINGS */                                /* [43][5,0x04] */
	0x080e,        /* READ_DEFAULT_LINK_POLICY_SETTINGS */                         /* [44][5,0x08] */
	0x080f,        /* WRITE_DEFAULT_LINK_POLICY_SETTINGS */                        /* [45][5,0x10] */
	0x0810,        /* FLOW_SPECIFICATION */                                        /* [46][5,0x20] */
	0x0c01,        /* SET_EVENT_MASK */                                            /* [47][5,0x40] */
	0x0c03,        /* RESET */                                                     /* [48][5,0x80] */

	/* Supported Commands[6] */
	0x0c05,        /* SET_EVENT_FILTER */                                          /* [49][6,0x01] */
	0x0c08,        /* FLUSH */                                                     /* [50][6,0x02] */
	0x0c09,        /* READ_PIN_TYPE */                                             /* [51][6,0x04] */
	0x0c0a,        /* WRITE_PIN_TYPE */                                            /* [52][6,0x08] */
	0x0c0b,        /* CREATE_NEW_UNIT_KEY */                                       /* [53][6,0x10] */
	0x0c0d,        /* READ_STORED_LINK_KEY */                                      /* [54][6,0x20] */
	0x0c11,        /* WRITE_STORED_LINK_KEY */                                     /* [55][6,0x40] */
	0x0c12,        /* DELETE_STORED_LINK_KEY */                                    /* [56][6,0x80] */

	/* Supported Commands[7] */
	0x0c13,        /* WRITE_LOCAL_NAME */                                          /* [57][7,0x01] */
	0x0c14,        /* READ_LOCAL_NAME */                                           /* [58][7,0x02] */
	0x0c15,        /* READ_CONNECTION_ACCEPT_TIMEOUT */                            /* [59][7,0x04] */
	0x0c16,        /* WRITE_CONNECTION_ACCEPT_TIMEOUT */                           /* [60][7,0x08] */
	0x0c17,        /* READ_PAGE_TIMEOUT */                                         /* [61][7,0x10] */
	0x0c18,        /* WRITE_PAGE_TIMEOUT */                                        /* [62][7,0x20] */
	0x0c19,        /* READ_SCAN_ENABLE */                                          /* [63][7,0x40] */
	0x0c1a,        /* WRITE_SCAN_ENABLE */                                         /* [64][7,0x80] */

	/* Supported Commands[8] */
	0x0c1b,        /* READ_PAGE_SCAN_ACTIVITY */                                   /* [65][8,0x01] */
	0x0c1c,        /* WRITE_PAGE_SCAN_ACTIVITY */                                  /* [66][8,0x02] */
	0x0c1d,        /* READ_INQUIRY_SCAN_ACTIVITY */                                /* [67][8,0x04] */
	0x0c1e,        /* WRITE_INQUIRY_SCAN_ACTIVITY */                               /* [68][8,0x08] */
	0x0c1f,        /* READ_AUTHENTICATION_ENABLE */                                /* [69][8,0x10] */
	0x0c20,        /* WRITE_AUTHENTICATION_ENABLE */                               /* [70][8,0x20] */
	0x0c21,        /* READ_ENCRYPTION_MODE */                                      /* [71][8,0x40] */
	0x0c22,        /* WRITE_ENCRYPTION_MODE */                                     /* [72][8,0x80] */

	/* Supported Commands[9] */
	0x0c23,        /* READ_CLASS_OF_DEVICE */                                      /* [73][9,0x01] */
	0x0c24,        /* WRITE_CLASS_OF_DEVICE */                                     /* [74][9,0x02] */
	0x0c25,        /* READ_VOICE_SETTING */                                        /* [75][9,0x04] */
	0x0c26,        /* WRITE_VOICE_SETTING */                                       /* [76][9,0x08] */
	0x0c27,        /* READ_AUTOMATIC_FLUSH_TIMEOUT */                              /* [77][9,0x10] */
	0x0c28,        /* WRITE_AUTOMATIC_FLUSH_TIMEOUT */                             /* [78][9,0x20] */
	0x0c29,        /* READ_NUM_BROADCAST_RETRANSMISSIONS */                        /* [79][9,0x40] */
	0x0c2a,        /* WRITE_NUM_BROADCAST_RETRANSMISSIONS */                       /* [80][9,0x80] */

	/* Supported Commands[10] */
	0x0c2b,        /* READ_HOLD_MODE_ACTIVITY */                                   /* [81][10,0x01] */
	0x0c2c,        /* WRITE_HOLD_MODE_ACTIVITY */                                  /* [82][10,0x02] */
	0x0c2d,        /* READ_TRANSMIT_POWER_LEVEL */                                 /* [83][10,0x04] */
	0x0c2e,        /* READ_SYNCHRONOUS_FLOW_CONTROL_ENABLE */                      /* [84][10,0x08] */
	0x0c2f,        /* WRITE_SYNCHRONOUS_FLOW_CONTROL_ENABLE */                     /* [85][10,0x10] */
	0x0c31,        /* SET_CONTROLLER_TO_HOST_FLOW_CONTROL */                       /* [86][10,0x20] */
	0x0c33,        /* HOST_BUFFER_SIZE */                                          /* [87][10,0x40] */
	0x0c35,        /* HOST_NUMBER_OF_COMPLETED_PACKETS */                          /* [88][10,0x80] */

	/* Supported Commands[11] */
	0x0c36,        /* READ_LINK_SUPERVISION_TIMEOUT */                             /* [89][11,0x01] */
	0x0c37,        /* WRITE_LINK_SUPERVISION_TIMEOUT */                            /* [90][11,0x02] */
	0x0c38,        /* READ_NUMBER_OF_SUPPORTED_IAC */                              /* [91][11,0x04] */
	0x0c39,        /* READ_CURRENT_IAC_LAP */                                      /* [92][11,0x08] */
	0x0c3a,        /* WRITE_CURRENT_IAC_LAP */                                     /* [93][11,0x10] */
	0x0c3b,        /* READ_PAGE_SCAN_PERIOD_MODE */                                /* [94][11,0x20] */
	0x0c3c,        /* WRITE_PAGE_SCAN_PERIOD_MODE */                               /* [95][11,0x40] */
	0x0c3d,        /* READ_PAGE_SCAN_MODE */                                       /* [96][11,0x80] */

	/* Supported Commands[12] */
	0x0c3e,        /* WRITE_PAGE_SCAN_MODE */                                      /* [97][12,0x01] */
	0x0c3f,        /* SET_AFH_HOST_CHANNEL_CLASSIFICATION */                       /* [98][12,0x02] */
	0x0000,        /* RESERVED */                                                  /* [99][12,0x04] */
	0x0000,        /* RESERVED */                                                  /* [100][12,0x08] */
	0x0c42,        /* READ_INQUIRY_SCAN_TYPE */                                    /* [101][12,0x10] */
	0x0c43,        /* WRITE_INQUIRY_SCAN_TYPE */                                   /* [102][12,0x20] */
	0x0c44,        /* READ_INQUIRY_MODE */                                         /* [103][12,0x40] */
	0x0c45,        /* WRITE_INQUIRY_MODE */                                        /* [104][12,0x80] */

	/* Supported Commands[13] */
	0x0c46,        /* READ_PAGE_SCAN_TYPE */                                       /* [105][13,0x01] */
	0x0c47,        /* WRITE_PAGE_SCAN_TYPE */                                      /* [106][13,0x02] */
	0x0c48,        /* READ_AFH_CHANNEL_ASSESSMENT_MODE */                          /* [107][13,0x04] */
	0x0c49,        /* WRITE_AFH_CHANNEL_ASSESSMENT_MODE */                         /* [108][13,0x08] */
	0x0000,        /* RESERVED */                                                  /* [109][13,0x10] */
	0x0000,        /* RESERVED */                                                  /* [110][13,0x20] */
	0x0000,        /* RESERVED */                                                  /* [111][13,0x40] */
	0x0000,        /* RESERVED */                                                  /* [112][13,0x80] */

	/* Supported Commands[14] */
	0x0000,        /* RESERVED */                                                  /* [113][14,0x01] */
	0x0000,        /* RESERVED */                                                  /* [114][14,0x02] */
	0x0000,        /* RESERVED */                                                  /* [115][14,0x04] */
	0x1001,        /* READ_LOCAL_VERSION_INFORMATION */                            /* [116][14,0x08] */
	0x0000,        /* RESERVED */                                                  /* [117][14,0x10] */
	0x1003,        /* READ_LOCAL_SUPPORTED_FEATURES */                             /* [118][14,0x20] */
	0x1004,        /* READ_LOCAL_EXTENDED_FEATURES */                              /* [119][14,0x40] */
	0x1005,        /* READ_BUFFER_SIZE */                                          /* [120][14,0x80] */

	/* Supported Commands[15] */
	0x1007,        /* READ_COUNTRY_CODE */                                         /* [121][15,0x01] */
	0x1009,        /* READ_BD_ADDR */                                              /* [122][15,0x02] */
	0x1401,        /* READ_FAILED_CONTACT_COUNTER */                               /* [123][15,0x04] */
	0x1402,        /* RESET_FAILED_CONTACT_COUNTER */                              /* [124][15,0x08] */
	0x1403,        /* READ_LINK_QUALITY */                                         /* [125][15,0x10] */
	0x1405,        /* READ_RSSI */                                                 /* [126][15,0x20] */
	0x1406,        /* READ_AFH_CHANNEL_MAP */                                      /* [127][15,0x40] */
	0x1407,        /* READ_CLOCK */                                                /* [128][15,0x80] */

	/* Supported Commands[16] */
	0x1801,        /* READ_LOOPBACK_MODE */                                        /* [129][16,0x01] */
	0x1802,        /* WRITE_LOOPBACK_MODE */                                       /* [130][16,0x02] */
	0x1803,        /* ENABLE_DEVICE_UNDER_TEST_MODE */                             /* [131][16,0x04] */
	0x0428,        /* SETUP_SYNCHRONOUS_CONNECTION */                              /* [132][16,0x08] */
	0x0429,        /* ACCEPT_SYNCHRONOUS_CONNECTION_REQUEST */                     /* [133][16,0x10] */
	0x042a,        /* REJECT_SYNCHRONOUS_CONNECTION_REQUEST */                     /* [134][16,0x20] */
	0x0000,        /* RESERVED */                                                  /* [135][16,0x40] */
	0x0000,        /* RESERVED */                                                  /* [136][16,0x80] */

	/* Supported Commands[17] */
	0x0c51,        /* READ_EXTENDED_INQUIRY_RESPONSE */                            /* [137][17,0x01] */
	0x0c52,        /* WRITE_EXTENDED_INQUIRY_RESPONSE */                           /* [138][17,0x02] */
	0x0c53,        /* REFRESH_ENCRYPTION_KEY */                                    /* [139][17,0x04] */
	0x0000,        /* RESERVED */                                                  /* [140][17,0x08] */
	0x0811,        /* SNIFF_SUBRATING */                                           /* [141][17,0x10] */
	0x0c55,        /* READ_SIMPLE_PAIRING_MODE */                                  /* [142][17,0x20] */
	0x0c56,        /* WRITE_SIMPLE_PAIRING_MODE */                                 /* [143][17,0x40] */
	0x0c57,        /* READ_LOCAL_OOB_DATA */                                       /* [144][17,0x80] */

	/* Supported Commands[18] */
	0x0c58,        /* READ_INQUIRY_RESPONSE_TRANSMIT_POWER_LEVEL */                /* [145][18,0x01] */
	0x0c59,        /* WRITE_INQUIRY_TRANSMIT_POWER_LEVEL */                        /* [146][18,0x02] */
	0x0c5a,        /* READ_DEFAULT_ERRONEOUS_DATA_REPORTING */                     /* [147][18,0x04] */
	0x0c5b,        /* WRITE_DEFAULT_ERRONEOUS_DATA_REPORTING */                    /* [148][18,0x08] */
	0x0000,        /* RESERVED */                                                  /* [149][18,0x10] */
	0x0000,        /* RESERVED */                                                  /* [150][18,0x20] */
	0x0000,        /* RESERVED */                                                  /* [151][18,0x40] */
	0x042b,        /* IO_CAPABILITY_REQUEST_REPLY */                               /* [152][18,0x80] */

	/* Supported Commands[19] */
	0x042c,        /* USER_CONFIRMATION_REQUEST_REPLY */                           /* [153][19,0x01] */
	0x042d,        /* USER_CONFIRMATION_REQUEST_NEGATIVE_REPLY */                  /* [154][19,0x02] */
	0x042e,        /* USER_PASSKEY_REQUEST_REPLY */                                /* [155][19,0x04] */
	0x042f,        /* USER_PASSKEY_REQUEST_NEGATIVE_REPLY */                       /* [156][19,0x08] */
	0x0430,        /* REMOTE_OOB_DATA_REQUEST_REPLY */                             /* [157][19,0x10] */
	0x1804,        /* WRITE_SIMPLE_PAIRING_DEBUG_MODE */                           /* [158][19,0x20] */
	0x0c5f,        /* ENHANCED_FLUSH */                                            /* [159][19,0x40] */
	0x0433,        /* REMOTE_OOB_DATA_REQUEST_NEGATIVE_REPLY */                    /* [160][19,0x80] */

	/* Supported Commands[20] */
	0x0000,        /* RESERVED */                                                  /* [161][20,0x01] */
	0x0000,        /* RESERVED */                                                  /* [162][20,0x02] */
	0x0c60,        /* SEND_KEYPRESS_NOTIFICATION */                                /* [163][20,0x04] */
	0x0434,        /* IO_CAPABILITY_REQUEST_NEGATIVE_REPLY */                      /* [164][20,0x08] */
	0x1408,        /* READ_ENCRYPTION_KEY_SIZE */                                  /* [165][20,0x10] */
	0x0000,        /* RESERVED */                                                  /* [166][20,0x20] */
	0x0000,        /* RESERVED */                                                  /* [167][20,0x40] */
	0x0000,        /* RESERVED */                                                  /* [168][20,0x80] */

	/* Supported Commands[21] */
	0x0000,        /* CREATE_PHYSICAL_LINK */                                      /* [169][21,0x01] */
	0x0000,        /* ACCEPT_PHYSICAL_LINK */                                      /* [170][21,0x02] */
	0x0000,        /* DISCONNECT_PHYSICAL_LINK */                                  /* [171][21,0x04] */
	0x0000,        /* CREATE_LOGICAL_LINK */                                       /* [172][21,0x08] */
	0x0000,        /* ACCEPT_LOGICAL_LINK */                                       /* [173][21,0x10] */
	0x0000,        /* DISCONNECT_LOGICAL_LINK */                                   /* [174][21,0x20] */
	0x0000,        /* LOGICAL_LINK_CANCEL */                                       /* [175][21,0x40] */
	0x0000,        /* FLOW_SPEC_MODIFY */                                          /* [176][21,0x80] */

	/* Supported Commands[22] */
	0x0000,        /* READ_LOGICAL_LINK_ACCEPT_TIMEOUT */                          /* [177][22,0x01] */
	0x0000,        /* WRITE_LOGICAL_LINK_ACCEPT_TIMEOUT */                         /* [178][22,0x02] */
	0x0c63,        /* SET_EVENT_MASK_PAGE_2 */                                     /* [179][22,0x04] */
	0x0000,        /* READ_LOCATION_DATA */                                        /* [180][22,0x08] */
	0x0000,        /* WRITE_LOCATION_DATA */                                       /* [181][22,0x10] */
	0x0000,        /* READ_LOCAL_AMP_INFO */                                       /* [182][22,0x20] */
	0x0000,        /* READ_LOCAL_AMP_ASSOC */                                      /* [183][22,0x40] */
	0x0000,        /* WRITE_REMOTE_AMP_ASSOC */                                    /* [184][22,0x80] */

	/* Supported Commands[23] */
	0x0c66,        /* READ_FLOW_CONTROL_MODE */                                    /* [185][23,0x01] */
	0x0c67,        /* WRITE_FLOW_CONTROL_MODE */                                   /* [186][23,0x02] */
	0x100a,        /* READ_DATA_BLOCK_SIZE */                                      /* [187][23,0x04] */
	0x0000,        /* RESERVED */                                                  /* [188][23,0x08] */
	0x0000,        /* RESERVED */                                                  /* [189][23,0x10] */
	0x0000,        /* ENABLE_AMP_RECEIVER_REPORTS */                               /* [190][23,0x20] */
	0x0000,        /* AMP_TEST_END */                                              /* [191][23,0x40] */
	0x0000,        /* AMP_TEST */                                                  /* [192][23,0x80] */

	/* Supported Commands[24] */
	0x0c68,        /* READ_ENHANCED_TRANSMIT_POWER_LEVEL */                        /* [193][24,0x01] */
	0x0000,        /* RESERVED */                                                  /* [194][24,0x02] */
	0x0000,        /* READ_BEST_EFFORT_FLUSH_TIMEOUT */                            /* [195][24,0x04] */
	0x0000,        /* WRITE_BEST_EFFORT_FLUSH_TIMEOUT */                           /* [196][24,0x08] */
	0x0000,        /* SHORT_RANGE_MODE */                                          /* [197][24,0x10] */
	0x0c6c,        /* READ_LE_HOST_SUPPORT */                                      /* [198][24,0x20] */
	0x0c6d,        /* WRITE_LE_HOST_SUPPORT */                                     /* [199][24,0x40] */
	0x0000,        /* RESERVED */                                                  /* [200][24,0x80] */

	/* Supported Commands[25] */
	0x2001,        /* LE_SET_EVENT_MASK */                                         /* [201][25,0x01] */
	0x2002,        /* LE_READ_BUFFER_SIZE */                                       /* [202][25,0x02] */
	0x2003,        /* LE_READ_LOCAL_SUPPORTED_FEATURES */                          /* [203][25,0x04] */
	0x0000,        /* RESERVED */                                                  /* [204][25,0x08] */
	0x2005,        /* LE_SET_RANDOM_ADDRESS */                                     /* [205][25,0x10] */
	0x2006,        /* LE_SET_ADVERTISING_PARAMETERS */                             /* [206][25,0x20] */
	0x2007,        /* LE_READ_ADVERTISING_CHANNEL_TX_POWER */                      /* [207][25,0x40] */
	0x2008,        /* LE_SET_ADVERTISING_DATA */                                   /* [208][25,0x80] */

	/* Supported Commands[26] */
	0x2009,        /* LE_SET_SCAN_RESPONSE_DATA */                                 /* [209][26,0x01] */
	0x200a,        /* LE_SET_ADVERTISE_ENABLE */                                   /* [210][26,0x02] */
	0x200b,        /* LE_SET_SCAN_PARAMETERS */                                    /* [211][26,0x04] */
	0x200c,        /* LE_SET_SCAN_ENABLE */                                        /* [212][26,0x08] */
	0x200d,        /* LE_CREATE_CONNECTION */                                      /* [213][26,0x10] */
	0x200e,        /* LE_CREATE_CONNECTION_CANCEL */                               /* [214][26,0x20] */
	0x200f,        /* LE_READ_WHITE_LIST_SIZE */                                   /* [215][26,0x40] */
	0x2010,        /* LE_CLEAR_WHITE_LIST */                                       /* [216][26,0x80] */

	/* Supported Commands[27] */
	0x2011,        /* LE_ADD_DEVICE_TO_WHITE_LIST */                               /* [217][27,0x01] */
	0x2012,        /* LE_REMOVE_DEVICE_FROM_WHITE_LIST */                          /* [218][27,0x02] */
	0x2013,        /* LE_CONNECTION_UPDATE */                                      /* [219][27,0x04] */
	0x2014,        /* LE_SET_HOST_CHANNEL_CLASSIFICATION */                        /* [220][27,0x08] */
	0x2015,        /* LE_READ_CHANNEL_MAP */                                       /* [221][27,0x10] */
	0x2016,        /* LE_READ_REMOTE_USED_FEATURES */                              /* [222][27,0x20] */
	0x2017,        /* LE_ENCRYPT */                                                /* [223][27,0x40] */
	0x2018,        /* LE_RAND */                                                   /* [224][27,0x80] */

	/* Supported Commands[28] */
	0x2019,        /* LE_START_ENCRYPTION */                                       /* [225][28,0x01] */
	0x201a,        /* LE_LONG_TERM_KEY_REQUEST_REPLY */                            /* [226][28,0x02] */
	0x201b,        /* LE_LONG_TERM_KEY_REQUEST_NEGATIVE_REPLY */                   /* [227][28,0x04] */
	0x201c,        /* LE_READ_SUPPORTED_STATES */                                  /* [228][28,0x08] */
	0x201d,        /* LE_RECEIVER_TEST */                                          /* [229][28,0x10] */
	0x201e,        /* LE_TRANSMITTER_TEST */                                       /* [230][28,0x20] */
	0x201f,        /* LE_TEST_END */                                               /* [231][28,0x40] */
	0x0000,        /* RESERVED */                                                  /* [232][28,0x80] */

	/* Supported Commands[29] */
	0x0000,        /* WRITE_EXTENDED_PAGE_TIMEOUT */                               /* [233][29,0x01] */
	0x0000,        /* READ_EXTENDED_INQUIRY_LENGTH */                              /* [234][29,0x02] */
	0x0000,        /* WRITE_EXTENDED_INQUIRY_LENGTH */                             /* [235][29,0x04] */
	0x0000,        /* ENHANCED_SETUP_SYNCHRONOUS_CONNECTION */                     /* [236][29,0x08] */
	0x0000,        /* ENHANCED_ACCEPT_SYNCHRONOUS_CONNECTION */                    /* [237][29,0x10] */
	0x0000,        /* READ_LOCAL_SUPPORTED_CODECS */                               /* [238][29,0x20] */
	0x0000,        /* SET_MWS_CHANNEL_PARAMETERS */                                /* [239][29,0x40] */
	0x0000,        /* SET_EXTERNAL_FRAME_CONFIGURATION */                          /* [240][29,0x80] */

	/* Supported Commands[30] */
	0x0000,        /* SET_MWS_SIGNALING */                                         /* [241][30,0x01] */
	0x0000,        /* SET_TRANSPORT_LAYER */                                       /* [242][30,0x02] */
	0x0000,        /* SET_MWS_SCAN_FREQUENCY_TABLE */                              /* [243][30,0x04] */
	0x0000,        /* GET_TRANSPORT_LAYER_CONFIGURATION */                         /* [244][30,0x08] */
	0x0000,        /* SET_MWS_PATTERN_CONFIGURATION */                             /* [245][30,0x10] */
	0x0000,        /* SET_TRIGGERED_CLOCK_CAPTURE */                               /* [246][30,0x20] */
	0x0000,        /* READ_EXTENDED_PAGE_TIMEOUT */                                /* [247][30,0x40] */
	0x0000,        /* RESERVED */                                                  /* [248][30,0x80] */
};
...
static const struct HCI_OpCodeGapStru hci_table_supportcmdgap[] = {
	{0, 0x0401},                           /* 0 */
	{15, 0x0411},                          /* 1 */
	{16, 0x0413},                          /* 2 */
	{17, 0x0415},                          /* 3 */
