...
#define HID_HOST_MAX_LATENCY                    0x020F
#define HID_HOST_MIN_TIMEOUT                    0x0210
...
#define GOEP_PSM                    0x200   /* Temp test for GOEP2.0 PSM attribute, it shall be modified later when the final value is defined by the SIG. */
...
// add by zhiyuan.chen 20161226 for iap2
#define CLS_IAP_SERVICE 0xDECA
#define CLS_IAP 0x00000000DECAFADEDECADEAFDECACAFE
...
#define OPTATTR_MASK_HOST_MAX_LATENCY   0x0200
#define OPTATTR_MASK_HOST_MIN_TIMEOUT   0x0400
...
#define OPTATTR_MASK_MPS_MPMD                               0x0001
/* Error code */
