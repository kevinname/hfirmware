...
{
  {HS_PIN_UART1_TX,   PAD_FUNC_UART1_TX,  CFG_PAD_DIR_OUTPUT,   CFG_PAD_PULL_NO,    3},
  {HS_PIN_UART1_RX,   PAD_FUNC_UART1_RX,  CFG_PAD_DIR_INPUT,    CFG_PAD_PULL_NO,    3},
  ...
  {HS_PIN_ADC_KEY,    PAD_FUNC_GPIO,      CFG_PAD_DIR_INPUT,    CFG_PAD_PULL_NO,    3},
  {HS_PIN_ADC_KEY_EX, PAD_FUNC_GPIO,      CFG_PAD_DIR_INPUT,    CFG_PAD_PULL_NO,    3},

  {PA5,               PAD_FUNC_GPIO,      CFG_PAD_DIR_OUTPUT,   CFG_PAD_PULL_UP,    3},
  {PA4,               PAD_FUNC_GPIO,      CFG_PAD_DIR_INPUT,    CFG_PAD_PULL_NO,    3},
};
