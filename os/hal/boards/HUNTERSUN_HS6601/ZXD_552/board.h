...
#define HS_PIN_ADC_KEY_EX         PA3     /* PA1~PA5 */

#define HS_ADCKEY_MAXNUM          8

#define HS_ADCKEY1_VOLT           0       /* mode */
#define HS_ADCKEY2_VOLT           97      /* play / stop */
#define HS_ADCKEY3_VOLT           210     /* v++ */
#define HS_ADCKEY4_VOLT           310     /* v-- */
#define HS_ADCKEY5_VOLT           427     /* function */
#define HS_ADCKEY6_VOLT           550     /* if voltage >= 950, the key can't be identify */
#define HS_ADCKEY7_VOLT           650     /* if voltage >= 950, the key can't be identify */
 ...
 * Board identifier.
 */
#define BOARD_NAME                "ZXD 552-HS01"
