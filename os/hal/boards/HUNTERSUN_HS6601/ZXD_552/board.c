...
static const hs_padinfo_t g_stPadDefault[] = 
{
  ...
  {HS_PIN_ADC_KEY,    PAD_FUNC_GPIO,      CFG_PAD_DIR_INPUT,    CFG_PAD_PULL_UP,      3},
  {HS_PIN_ADC_KEY_EX, PAD_FUNC_GPIO,      CFG_PAD_DIR_INPUT,    CFG_PAD_PULL_UP,      3},

  {PB3,               PAD_FUNC_GPIO,      CFG_PAD_DIR_INPUT,    CFG_PAD_PULL_UP,      3},
  {PB5,               PAD_FUNC_GPIO,      CFG_PAD_DIR_OUTPUT,   CFG_PAD_PULL_NO,      3},
};
