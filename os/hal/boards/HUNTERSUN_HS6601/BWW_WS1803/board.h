...
/*
 * BWW_WS1803 Board Pin Define start 
 */
#define HS_PIN_AUX_PLUGIN         PA0 
#define HS_PIN_SD_DETECT          PA15
#define HS_PIN_DEEP_SLEEP_WAKEUP  PA0     /* PA0~3 */
#define HS_PIN_AUDIO_PA           PA13     

#define HS_PIN_UART1_RX           PA14
#define HS_PIN_UART1_TX           PB0
...
#define HS_ADCKEY1_VOLT           0      /* mode */
#define HS_ADCKEY2_VOLT           235     /* play / stop */
#define HS_ADCKEY3_VOLT           710     /* v++ */
#define HS_ADCKEY4_VOLT           95     /* v-- */
#define HS_ADCKEY5_VOLT           431     /* function */
...
#define HS_BATTERY_EMPTY_ALARM    3220.0  /* when battery voltage <= the value, alarmed! unit: mv */
