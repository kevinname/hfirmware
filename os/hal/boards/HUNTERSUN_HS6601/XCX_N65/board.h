 ...
 */
#define HS_PIN_ADC_KEY            PA1     /* PA1~PA5 */
#define HS_PIN_ADC_KEY_EX         PA0     /* PA1~PA5 */

#define HS_ADCKEY_MAXNUM          8

#define HS_ADCKEY1_VOLT           342       /* mode */
#define HS_ADCKEY2_VOLT           143      /* play / stop */
#define HS_ADCKEY3_VOLT           3        /* v++ */
#define HS_ADCKEY4_VOLT           797     /* v-- */
#define HS_ADCKEY5_VOLT           587     /* function */
